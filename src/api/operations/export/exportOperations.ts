...
export class ExportOperations extends OperationsModel {
    ...
    private createExportOperationRoute(workspaceId: string, projectId: string, versionId: string, exportId: string): string {
    ...
    async getExport(workspaceId: string, projectId: string, versionId: string, exportId: string): Promise<ExportResponse> {
        try {
            const exportUrl = this.createExportOperationRoute(workspaceId, projectId, versionId, exportId)
